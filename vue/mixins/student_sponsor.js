 ...
 * 
 * ============================================================================
 * Checks for admin, student, and sponsor (Levels 1,3,4) permissions only.
 */
...
const page_level_3 = 3
const page_level_4 = 4
...
export default {
  ...
  beforeMount: async function(){
    ...
    if((this.PermissionLevel == page_level_1) || 
        (this.PermissionLevel == page_level_3) ||
        (this.PermissionLevel == page_level_4)){

      this.allowAccess = 1
    }
    else if((this.PermissionLevel != page_level_1)
            || (this.PermissionLevel != page_level_3)
            || (this.PermissionLevel != page_level_4)){
