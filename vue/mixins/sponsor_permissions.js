 ...
 * 
 * ============================================================================
 * Checks for admin and sponsor (Levels 1,4) permissions only.
 */
...
export default {
  ...
  beforeMount: async function(){
    ...
    if(this.PermissionLevel == page_level_4){
     
        // (this.PermissionLevel == page_level_1)){

      this.allowAccess = 1
    }
    else if(this.PermissionLevel != page_level_4){
