 ...
 * 
 * ============================================================================
 * Checks for admin and student (Levels 1,3) permissions only.
 */
...
export default {
  ...
  beforeMount: async function(){
    ...
    if((this.PermissionLevel == page_level_3) || 
        (this.PermissionLevel == page_level_1)){

      this.allowAccess = 1
    }
    else if((this.PermissionLevel != page_level_3) ||
            (this.PermissionLevel != page_level_1)){
