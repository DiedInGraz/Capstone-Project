...
export class HomePage extends React.Component { // eslint-disable-line react/prefer-stateless-function
  ...
  handleSubmit = (e) => { // eslint-disable-line consistent-return
    e.preventDefault();
    const apiUrl = ('http://' + process.env.VUE_APP_API_URL + ':1337') || 'http://localhost:1337' = this.props.match.params.env ? `${this.props.match.params.slug}/${this.props.match.params.env}` : this.props.match.params.slug;
  ...
  handleSubmitEditDatabase = (databaseName) => { // eslint-disable-line consistent-return
    ...
    const apiUrl = ('http://' + process.env.VUE_APP_API_URL + ':1337') || 'http://localhost:1337' = `${databaseName}/${this.props.match.params.env}`;
